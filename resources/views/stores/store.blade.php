                            ...
                            @if( count($store['locations']) >= 1 )
                                @foreach($store['locations'] as $location)
                                    <tr class="text-center">
                                        ...
                                        <x-table-column>
                                            <a href="{{ route('store.location.edit', ['storeUuid' => $store->uuid, 'locationUuid' => $location['uuid']]) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                                                Edit
                                            </a>
                                        </x-table-column>
                                    </tr>
